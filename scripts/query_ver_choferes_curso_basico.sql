...
chofer_curso.id as choferCursoId, chofer_curso.aprobado as aprobado, chofer_curso.pagado,
...
WHERE curso.tipoCurso_id = 1 AND chofer.tiene_curso_basico = 0 AND chofer_curso.aprobado > 3 AND chofer_curso.pagado = 1
